  ...
  return (
    <footer className="bg-bark text-cream">
      <div className="w-[min(1280px,100%-2rem)] mx-auto pt-16 pb-10">
        <div
          className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.8fr_1fr_1fr_1fr_1.4fr]
...
<div>
  ...
  <Image
    ...
    width={82}
    height={72}
    className=" object-contain brightness-0 invert sepia-[30%] saturate-[400%] hue-rotate-[10deg]"
  />
</div>
    
    {/* Brand text */}
    <div className="leading-tight">
      <span className="font-display text-lg font-semibold text-cream block tracking-wide">
        {SITE.name.split(" ")[0]}
      </span>
      <span className="text-[0.6rem] tracking-[0.22em] uppercase text-cream/40 block mt-0.5">
        {SITE.tagline}
      </span>
    </div>
  </div>
  ...
  <p className="text-sm text-cream/55 leading-relaxed mb-5 max-w-[220px]">
    ...
    joint health and more. Science-backed, nature-sourced.
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2">
              {[
                ...
                [
                  "Respiratory & Allergy",
                  "/products?category=respiratory-allergy",
                ],
                ["Vitamins & Minerals", "/products?category=vitamins-minerals"],
                [
                  "Neurological Support",
                  "/products?category=neurological-support",
                ],
                ["Muscle & Movement", "/products?category=muscle-movement"],
                [
                  "Bladder & Kidney",
                  "/products?category=bladder-kidney-health",
                ],
              ].map(([label, href]) => (
                <li key={label}>
                  <Link
          ...
          <div>
            ...
            <a
              href={`https://wa.me/${SITE.whatsapp}?text=Hi%20${encodeURIComponent(SITE.name)}!`}
              target="_blank"
            ...
            <p className="text-xs text-cream/30 mt-5 leading-relaxed">
              These products are food supplements, not medicines. Always consult
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-4 text-xs text-cream/35">
            ...
            <p className="flex items-center gap-1">
              Made with <span className="text-sage-light">♥</span> by{" "}
              <a
                href="https://www.linkedin.com/in/maina-cyrus-3b2143363/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-cream/60 transition-colors"
              >
