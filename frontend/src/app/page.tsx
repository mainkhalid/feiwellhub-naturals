...
import { ArrowRight, Leaf, ShieldCheck, Heart, Recycle, Star } from 'lucide-react'
import { Shield, Zap, Bone, Wind, Pill, Brain, Dumbbell, Droplets } from 'lucide-react'
...
const TRUST_BADGES = [
  ...
  { Icon: ShieldCheck, label: 'KEBS Certified'     },
...
const TESTIMONIALS = [
  ...
  {
    name: 'James K.', location: 'Westlands',
  ...
  {
    name: 'Aisha O.', location: 'Kilimani',
...
const MARQUEE_ITEMS = [
  ...
  '💪 Muscle Strength', '💧 Bladder Control', '🌿 KEBS Certified',
]
  ...
  return (
    <>
      ...
      <main>
        ...
        {/* Testimonials */}
        <section className="py-14 bg-cream" aria-labelledby="reviews-heading">
          <div className="w-[min(1280px,100%-2rem)] mx-auto">
            <div className="text-center mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {TESTIMONIALS.map(({ name, location, text, rating }) => (
                <div key={name} className="bg-white rounded-2xl p-6 border border-gray-100">
        ...
        <section className="bg-bark py-16">
          <div className="w-[min(1280px,100%-2rem)] mx-auto
            ...
            <div className="flex gap-3 flex-wrap shrink-0">
              <Link href="/contact" className="btn bg-sage text-white border-sage hover:bg-sage/90">
                Get Free Advice
              </Link>
