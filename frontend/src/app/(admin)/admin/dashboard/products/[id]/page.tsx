...
export default function EditProductPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    adminGetProduct(parseInt(params.id)).then(res => setProduct(res.data))
  }, [params.id])

  async function handleSubmit(data: any) {
    setLoading(true)
    try {
      const res = await adminUpdateProduct(parseInt(params.id), {
        ...data,
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <h1 className="font-display text-3xl text-bark">Edit Product</h1>
